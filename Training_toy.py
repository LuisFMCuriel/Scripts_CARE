...
def train( Training_source = "/content/gdrive/My Drive/cloud_colab/CARE (2D)/Train_1000img/Low",
                Training_target = "/content/gdrive/My Drive/cloud_colab/CARE (2D)/Train_1000img/High",
                model_name = "No_name",
                model_path = "/content/gdrive",
